<?php
// src/Mondel/SiteBundle/Twig/Extensions/MondelSiteExtension.php

namespace Mondel\SiteBundle\Twig\Extensions;

class MondelSiteExtension extends \Twig_Extension
{
