...
class StringHelper
{
    ...
    private static $palabras_prohibidas = array(
        ...
        'porong', 'orto', 'ojete', 'trola', 'trolo','chanchos'
    );
    ...
    public static function slugify($cadena)
    {
        ...
        $valor = strtolower(preg_replace('/[^A-Z^a-z^0-9^\/]+/', '-', preg_replace('/([a-z\d])([A-Z])/', '\1_\2', preg_replace('/([A-Z]+)([A-Z][a-z])/', '\1_\2', preg_replace('/::/', '/', $valor)))));
